...
const VOICE_CONFIG = {
  ...
  // v35: the three languages added in v33a
  // Punjabi — Google TTS has pa-IN (Gurmukhi-trained, but pronounces the spoken
  //   language fine; our text is Shahmukhi script so pronunciation may vary —
  //   acceptable approximation until a Shahmukhi-native voice exists).
  pa: { languageCode: "pa-IN", voiceName: "pa-IN-Wavenet-A", gender: "FEMALE" },
  // Indonesian — well-supported.
  id: { languageCode: "id-ID", voiceName: "id-ID-Wavenet-A", gender: "FEMALE" },
  // Nigerian Pidgin — no dedicated TTS voice exists. Pidgin is English-lexified,
  //   so a Nigerian/African English voice is the closest. en-US as fallback if
  //   the regional voice isn't available on your account.
  pcm: { languageCode: "en-US", voiceName: "en-US-Wavenet-F", gender: "FEMALE" },
};
