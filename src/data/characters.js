...
export const CHARACTERS = {
  ur: {
    ...
    // In-lesson reactions — short, native, varied. Shown DURING practice so
    // the tutor feels present, not just at the start/end. Authentic > polished.
    reactions: {
  ...
  ja: {
    ...
    reactions: {
      ...
      streak: ["Sugoi!","Choushi ii ne!","Sono chousi!"],
    },
  },
