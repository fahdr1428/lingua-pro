...
export const JOURNEY = {
  // v102 — Vietnamese. Every stop is a real exchange: the phrase you'd hear and
  // the one you'd say back. Northern (Hanoi) forms, matching the pack.
  vi: {
    chapterTitle: "Meeting people",
    stops: [
      { id: "vi-c1-s1", done: "You can greet someone and answer back",
        next: "you'll be able to greet someone and say how you are",
        they: { text: "Xin chào, chị khỏe không?", translit: "xin chao, chi khoe khong", en: "Hello, how are you?" },
        you: { text: "Tôi khỏe, cảm ơn", translit: "toi khoe, cam on", en: "I'm well, thank you" },
        unitIndex: 0 },
      { id: "vi-c1-s2", done: "You can give your name",
        next: "you'll be able to say who you are",
        they: { text: "Bạn tên là gì?", translit: "ban ten la gi", en: "What's your name?" },
        you: { text: "Tên tôi là Linh", translit: "ten toi la Linh", en: "My name is Linh" },
        unitIndex: 1 },
      { id: "vi-c1-s3", done: "You can talk about your family",
        next: "you'll be able to say who's at home",
        they: { text: "Gia đình bạn có đông không?", translit: "gia dinh ban co dong khong", en: "Is your family big?" },
        you: { text: "Gia đình tôi rất đông", translit: "gia dinh toi rat dong", en: "My family is very big" },
        unitIndex: 2 },
      { id: "vi-c1-s4", done: "You can ask what something costs",
        next: "you'll be able to ask a price and understand the answer",
        they: { text: "Cái này bao nhiêu tiền?", translit: "cai nay bao nhieu tien", en: "How much is this?" },
        you: { text: "Đắt quá! Rẻ hơn được không?", translit: "dat qua, re hon duoc khong", en: "Too expensive! Can it be cheaper?" },
        unitIndex: 3 },
      { id: "vi-c1-s5", done: "You can order food",
        next: "you'll be able to order without pointing",
        they: { text: "Anh muốn ăn gì?", translit: "anh muon an gi", en: "What would you like to eat?" },
        you: { text: "Cho tôi một bát phở", translit: "cho toi mot bat pho", en: "One bowl of phở for me" },
        unitIndex: 4 },
      { id: "vi-c1-s6", done: "You can say what you're doing",
        next: "you'll be able to say where you're going and why",
        they: { text: "Bạn đi đâu đấy?", translit: "ban di dau day", en: "Where are you going?" },
        you: { text: "Tôi đi chợ mua rau", translit: "toi di cho mua rau", en: "I'm going to the market to buy vegetables" },
        unitIndex: 5 },
      { id: "vi-c1-s7", done: "You can find your way",
        next: "you'll be able to ask where something is",
        they: { text: "Anh tìm gì ạ?", translit: "anh tim gi a", en: "What are you looking for?" },
        you: { text: "Nhà vệ sinh ở đâu?", translit: "nha ve sinh o dau", en: "Where is the bathroom?" },
        unitIndex: 6 },
      { id: "vi-c1-s8", done: "You can say how you feel and when",
        next: "you'll be able to make plans and say how you are",
        they: { text: "Ngày mai bạn rảnh không?", translit: "ngay mai ban ranh khong", en: "Are you free tomorrow?" },
        you: { text: "Hôm nay tôi mệt, ngày mai được", translit: "hom nay toi met, ngay mai duoc", en: "Today I'm tired, tomorrow is fine" },
        unitIndex: 7 },
    ],
  },

  // v102 — Yoruba. Greetings carry most of the social weight in Yoruba, which
  // is why two of the eight stops are greetings and neither is filler.
  yo: {
    chapterTitle: "Meeting people",
    stops: [
      { id: "yo-c1-s1", done: "You can greet someone properly",
        next: "you'll be able to greet someone and answer back",
        they: { text: "Báwo ni?", translit: "bawo ni", en: "How are you?" },
        you: { text: "Àlàáfíà ni, ẹ ṣé", translit: "alaafia ni, e she", en: "All is well, thank you" },
        unitIndex: 0 },
      { id: "yo-c1-s2", done: "You can greet by time of day",
        next: "you'll be able to greet anyone at any hour",
        they: { text: "Ẹ káàárọ̀", translit: "e kaaaro", en: "Good morning" },
        you: { text: "Ẹ káàárọ̀ ma, ṣé àlàáfíà ni?", translit: "e kaaaro ma, she alaafia ni", en: "Good morning ma'am, is all well?" },
        unitIndex: 0 },
      { id: "yo-c1-s3", done: "You can give your name",
        next: "you'll be able to introduce yourself",
        they: { text: "Kí ni orúkọ rẹ?", translit: "ki ni oruko re", en: "What is your name?" },
        you: { text: "Orúkọ mi ni Adé", translit: "oruko mi ni Ade", en: "My name is Ade" },
        unitIndex: 1 },
      { id: "yo-c1-s4", done: "You can talk about your family",
        next: "you'll be able to say who's at home",
        they: { text: "Ìdílé rẹ pọ̀ bí?", translit: "idile re po bi", en: "Is your family large?" },
        you: { text: "Ìdílé mi tóbi", translit: "idile mi tobi", en: "My family is big" },
        unitIndex: 2 },
      { id: "yo-c1-s5", done: "You can ask the price",
        next: "you'll be able to buy something at the market",
        they: { text: "Élòó ni èyí?", translit: "eloo ni eyi", en: "How much is this?" },
        you: { text: "Ó wọ́n jù, ẹ jọ̀ọ́", translit: "o won ju, e joo", en: "It's too expensive, please" },
        unitIndex: 3 },
      { id: "yo-c1-s6", done: "You can eat with people",
        next: "you'll be able to accept food and say what you want",
        they: { text: "Ṣé o fẹ́ jẹun?", translit: "she o fe jeun", en: "Do you want to eat?" },
        you: { text: "Bẹ́ẹ̀ni, mo fẹ́ ìrẹsì", translit: "beeni, mo fe iresi", en: "Yes, I want rice" },
        unitIndex: 4 },
      { id: "yo-c1-s7", done: "You can find your way",
        next: "you'll be able to ask where something is",
        they: { text: "Kí ni o ń wá?", translit: "ki ni o n wa", en: "What are you looking for?" },
        you: { text: "Ilé ìwẹ̀ wà níbo?", translit: "ile iwe wa nibo", en: "Where is the bathroom?" },
        unitIndex: 6 },
      { id: "yo-c1-s8", done: "You can say how you feel and when",
        next: "you'll be able to make plans and say how you are",
        they: { text: "Ṣé o máa wá ọ̀la?", translit: "she o maa wa ola", en: "Will you come tomorrow?" },
        you: { text: "Ó rẹ̀ mí lónìí, ọ̀la ni", translit: "o re mi loni, ola ni", en: "I'm tired today, tomorrow then" },
        unitIndex: 7 },
    ],
  },
  ...
  ml: {
    chapterTitle: "Meeting people",
    stops: [
      { id: "ml-c1-s1", done: "You can greet someone properly", next: "you'll be able to greet someone and answer back",
        they: { text: "നമസ്കാരം, സുഖമാണോ?", translit: "namaskaaram, sukhamaano?", en: "hello, are you well?" },
        you: { text: "സുഖമാണ്, നന്ദി", translit: "sukhamaanu, nandi", en: "I'm well, thank you" }, unitIndex: 0 },
      { id: "ml-c1-s2", done: "You can thank someone and say sorry", next: "you'll be able to be polite",
        they: { text: "ഇത് നിങ്ങൾക്കാണ്", translit: "ithu ningalkkaanu", en: "this is for you" },
        you: { text: "വളരെ നന്ദി", translit: "valare nandi", en: "thank you very much" }, unitIndex: 1 },
      { id: "ml-c1-s3", done: "You can say who you are", next: "you'll be able to introduce yourself",
        they: { text: "നിങ്ങളുടെ പേര് എന്താണ്?", translit: "ningalude peru enthaanu?", en: "what is your name?" },
        you: { text: "എന്റെ പേര് ശ്രീജ", translit: "ente peru Sreeja", en: "my name is Sreeja" }, unitIndex: 2 },
      { id: "ml-c1-s4", done: "You can talk about your family", next: "you'll be able to name your family",
        they: { text: "കുടുംബത്തിൽ ആരൊക്കെയുണ്ട്?", translit: "kudumbathil aarokkeyundu?", en: "who is in your family?" },
        you: { text: "അമ്മ, അച്ഛൻ, ഒരു ചേട്ടൻ", translit: "amma, achchan, oru chettan", en: "mother, father, an older brother" }, unitIndex: 3 },
      { id: "ml-c1-s5", done: "You can say how you feel", next: "you'll be able to say how you are",
        they: { text: "സുഖമില്ലേ?", translit: "sukhamille?", en: "are you not well?" },
        you: { text: "കുറച്ച് ക്ഷീണമുണ്ട്", translit: "kurachu ksheenamundu", en: "I'm a little tired" }, unitIndex: 4 },
      { id: "ml-c1-s6", done: "You can ask for food and drink", next: "you'll be able to ask for what you want",
        they: { text: "എന്ത് വേണം?", translit: "enthu venam?", en: "what would you like?" },
        you: { text: "ഒരു ചായ വേണം", translit: "oru chaaya venam", en: "I'd like a tea" }, unitIndex: 5 },
      { id: "ml-c1-s7", done: "You can say what you're doing", next: "you'll be able to use everyday verbs",
        they: { text: "എന്ത് ചെയ്യുന്നു?", translit: "enthu cheyyunnu?", en: "what are you doing?" },
        you: { text: "ഞാൻ ജോലി ചെയ്യുന്നു", translit: "njaan joli cheyyunnu", en: "I'm working" }, unitIndex: 6 },
      { id: "ml-c1-s8", done: "You can ask a price and find your way", next: "you'll be able to manage out in the world",
        they: { text: "ഇതിന്റെ വില എത്ര?", translit: "ithinte vila ethra?", en: "how much is this?" },
        you: { text: "അഞ്ച് രൂപ", translit: "anchu roopa", en: "five rupees" }, unitIndex: 7 },
    ],
  },
  ...
  ta: {
    chapterTitle: "Meeting people",
    stops: [
      { id: "ta-c1-s1", done: "You can greet someone properly", next: "you'll be able to greet someone and answer back",
        they: { text: "வணக்கம், எப்படி இருக்கீங்க?", translit: "vanakkam, eppadi irukkeenga?", en: "hello, how are you?" },
        you: { text: "நல்லா இருக்கேன், நன்றி", translit: "nallaa irukken, nandri", en: "I'm well, thank you" }, unitIndex: 0 },
      { id: "ta-c1-s2", done: "You can thank someone and say sorry", next: "you'll be able to be polite",
        they: { text: "இது உங்களுக்கு", translit: "idhu ungalukku", en: "this is for you" },
        you: { text: "ரொம்ப நன்றி", translit: "romba nandri", en: "thank you very much" }, unitIndex: 1 },
      { id: "ta-c1-s3", done: "You can say who you are", next: "you'll be able to introduce yourself",
        they: { text: "உங்க பெயர் என்ன?", translit: "unga peyar enna?", en: "what is your name?" },
        you: { text: "என் பெயர் மீனா", translit: "en peyar Meena", en: "my name is Meena" }, unitIndex: 2 },
      { id: "ta-c1-s4", done: "You can talk about your family", next: "you'll be able to name your family",
        they: { text: "வீட்டில யாரு இருக்காங்க?", translit: "veettila yaaru irukkaanga?", en: "who is at home?" },
        you: { text: "அம்மா, அப்பா, ஒரு அண்ணா", translit: "amma, appa, oru annaa", en: "mother, father, an older brother" }, unitIndex: 3 },
      { id: "ta-c1-s5", done: "You can say how you feel", next: "you'll be able to say how you are",
        they: { text: "உடம்பு சரியில்லையா?", translit: "udambu sariyillaiyaa?", en: "are you unwell?" },
        you: { text: "கொஞ்சம் சோர்வா இருக்கு", translit: "konjam sorvaa irukku", en: "I'm a little tired" }, unitIndex: 4 },
      { id: "ta-c1-s6", done: "You can ask for food and drink", next: "you'll be able to ask for what you want",
        they: { text: "என்ன வேணும்?", translit: "enna venum?", en: "what would you like?" },
        you: { text: "ஒரு டீ வேணும்", translit: "oru tea venum", en: "I'd like a tea" }, unitIndex: 5 },
      { id: "ta-c1-s7", done: "You can say what you're doing", next: "you'll be able to use everyday verbs",
        they: { text: "என்ன செய்யறீங்க?", translit: "enna seyyareenga?", en: "what are you doing?" },
        you: { text: "நான் வேலை செய்யறேன்", translit: "naan velai seyyaren", en: "I'm working" }, unitIndex: 6 },
      { id: "ta-c1-s8", done: "You can ask a price and find your way", next: "you'll be able to manage out in the world",
        they: { text: "இது எவ்வளவு?", translit: "idhu evvalavu?", en: "how much is this?" },
        you: { text: "ஐந்து ரூபாய்", translit: "ainthu roopaay", en: "five rupees" }, unitIndex: 7 },
    ],
  },
  ...
  so: {
    chapterTitle: "Meeting people",
    stops: [
      { id: "so-c1-s1", done: "You can greet someone properly", next: "you'll be able to greet someone and answer back",
        they: { text: "Iska warran?", translit: "iska warran", en: "how are you?" },
        you: { text: "Nabad baan ahay, mahadsanid", translit: "nabad baan ahay", en: "I am well, thank you" }, unitIndex: 0 },
      { id: "so-c1-s2", done: "You can thank someone and say sorry", next: "you'll be able to be polite",
        they: { text: "Kani waa kaaga", translit: "kani waa kaaga", en: "this is for you" },
        you: { text: "Aad baad u mahadsantahay", translit: "aad baad u mahadsantahay", en: "thank you very much" }, unitIndex: 1 },
      { id: "so-c1-s3", done: "You can say who you are", next: "you'll be able to introduce yourself",
        they: { text: "Magacaa?", translit: "magacaa", en: "what is your name?" },
        you: { text: "Magacaygu waa Hodan", translit: "magacaygu waa Hodan", en: "my name is Hodan" }, unitIndex: 2 },
      { id: "so-c1-s4", done: "You can talk about your family", next: "you'll be able to name your family",
        they: { text: "Qoyskaagu ma weyn yahay?", translit: "qoyskaagu ma weyn yahay", en: "is your family big?" },
        you: { text: "Hooyo, aabbe, iyo laba walaal", translit: "hooyo, aabbe, iyo laba walaal", en: "mother, father and two siblings" }, unitIndex: 3 },
      { id: "so-c1-s5", done: "You can say how you feel", next: "you'll be able to say how you are",
        they: { text: "Ma daallan tahay?", translit: "ma daallan tahay", en: "are you tired?" },
        you: { text: "Haa, waan daallanahay", translit: "haa, waan daallanahay", en: "yes, I am tired" }, unitIndex: 4 },
      { id: "so-c1-s6", done: "You can ask for food and drink", next: "you'll be able to ask for what you want",
        they: { text: "Maxaad rabtaa?", translit: "maxaad rabtaa", en: "what would you like?" },
        you: { text: "Shaah baan rabaa", translit: "shaah baan rabaa", en: "I'd like a tea" }, unitIndex: 5 },
      { id: "so-c1-s7", done: "You can say what you're doing", next: "you'll be able to use everyday verbs",
        they: { text: "Maxaad samaynaysaa?", translit: "maxaad samaynaysaa", en: "what are you doing?" },
        you: { text: "Waan shaqaynayaa", translit: "waan shaqaynayaa", en: "I'm working" }, unitIndex: 6 },
      { id: "so-c1-s8", done: "You can ask a price and find your way", next: "you'll be able to manage out in the world",
        they: { text: "Qiimuhu waa imisa?", translit: "qiimuhu waa imisa", en: "how much is it?" },
        you: { text: "Shan doolar", translit: "shan doolar", en: "five dollars" }, unitIndex: 7 },
    ],
  },
